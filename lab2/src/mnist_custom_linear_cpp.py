...
FilePath: \AI-System\MSRA-USTC-AISystemProject-2021\lab2\mnist_custom_linear_cpp.py
'''
...
class myLinear(nn.Module):
    ...
    def forward(self,x):
        return mylinearFunction.apply(x,self.w)
...
def main():
    ...
    # profile model
    f = open("../profile/"+ "mylinear_cpp"+str(datetime.now().hour)+'_'+str(datetime.now().minute)+".txt", mode='w', encoding='utf-8')
